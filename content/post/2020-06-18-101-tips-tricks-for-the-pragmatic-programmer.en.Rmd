---
title: 101 Tips & Tricks for the Pragmatic Programmer
author: Jimmy Briggs
date: '2020-06-18'
slug: 101-tips-tricks-for-the-pragmatic-programmer
categories:
  - Advice
  - Tips & Tricks
  - Programming
tags:
  ...
  - List
  - Tips & Tricks
description: 'Curated List 101 General Programming Tips and Tricks'
featured_image: '/images/pragmatic_programmer.png'
show_reading_time: true
---

# The Journey to Mastery

Over time I have compiled a list of various programming related tips and tricks 
that help me stay clear, motivated, and in-tune with my work. Many of the listed
tips were originally from the book [Pragmatic Programmer](https://www.amazon.com/Pragmatic-Programmer-journey-mastery-Anniversary/dp/0135957052/ref=pd_lpo_14_t_0/146-0897640-2642310?_encoding=UTF8&pd_rd_i=0135957052&pd_rd_r=65420006-fb90-449e-b1f9-cb54a3ee1b00&pd_rd_w=fXjeQ&pd_rd_wg=fZH00&pf_rd_p=7b36d496-f366-4631-94d3-61b87b52511b&pf_rd_r=TCEJ9F1TG2XY34BCR6RM&psc=1&refRID=TCEJ9F1TG2XY34BCR6RM).

The list is helpful for all programmers and not specific to any language or domain.

If you find yourself drifting or wandering down the seemingly inevitable 
programming rabbit hole, take a gander at the list below. It helps you take a 
step back, course correct, and align your priorities to help spark yourself back 
into gear.

Programming is not easy. To cope with the increasingly complex and idiosyncratic 
realm of technology and coding I find it extremely useful to reference this list 
on a regular basis.
...
1. **Provide Options**  
Don’t Make Lame Excuses. Instead of excuses, provide options. 
...
Don’t be swayed by vendors, media hype, or dogma. Analyze information in
terms of you and your project.

1. **English is Just Another Programming Language**  
Treat English as Just Another Programming Language. Write documents as 
you would write code honor the DRY principle, ETC, automation, and so on.
...
A thing is well designed if it adapts to the people who use it. For code, 
that means it must adapt by changing.
...
It is rare to find a bug in the OS or the compiler, or even a third-party product 
or library. The bug is most likely in the application.
...
If it can’t happen, use assertions to ensure that it won’t. Assertions 
validate your assumptions. Use them to protect your code from an uncertain world.
...
1. **Tell, Don’t Ask**  
Don’t get values from an object, transform them, and then stick them back. 
...
Interfaces make polymorphism explicit without the coupling introduced by
inheritance.

1. **Delegate to Services**  
Has-A Trumps Is-A: Don’t inherit from services, contain them.
...
When code relies on values that may change after the application has gone 
live, keep those values external to the app. When you application will run 
in different environments, and potentially for different customers, keep
the environment and customer specific values outside the app.

1. **Analyze Workflow to Improve Concurrency**  
Exploit concurrency in your user’s workflow.

1. **Shared State Is Incorrect State**  
Shared state opens a large can of worms that can often only be 
fixed by rebooting

1. **Random Failures Are Often Concurrency Issues**  
Variations in timing and context can expose concurrency bugs, 
but in inconsistent and irreproducible ways.
...
When it feels like your code is pushing back, it’s really your 
subconscious trying to tell you something’s wrong.
...
Property-based tests will try things you never thought to try, and exercise 
your code in ways is wasn’t meant to be used.
...
1. **Programmers Help People Understand What They Want**  
...
1. **Work with a User to Think Like a User**  
It’s the best way to gain insight into how the system will really be used.

1. **Policy Is Metadata**  
Don’t hardcode policy into a system; instead express it as metadata used by 
the system.
...
1. **Don't Go into the Code Alone**  
Programming can be difficult and demanding. Take a friend with you.

1. **Agile Is Not a Noun; Agile Is How You Do Things**  
Agile is an adjective it’s how you do something.

1. **Maintain Small Stable Teams**  
Teams should be small and stable, where everyone trusts each other and
depends on each other.

1. **Schedule It to Make It Happen**  
If you don’t schedule it, it’s not going to happen. Schedule reflection, 
experimentation, learning and skills improvement.

1. **Organize Fully Functional Teams**  
Organize Around Functionality, Not Job Functions. Don’t separate UI/UX designers
from coders, frontend from backend, testers from data modelers, design from 
deployment. Build teams so you can build code end-to-end, incrementally and 
iteratively.

1. **Do What Works, Not What’s Fashionable**  
Don’t adopt a development method or technique just because other companies 
are doing it. Adopt what works for your team, in your context.

1. **Deliver When Users Need It**  
Don’t wait weeks or months to deliver just because your process demands it.

1. **Use Version Control to Drive Builds, Tests, and Releases**  
...
1. **Delight Users, Don’t Just Deliver Code**
...
1. **Don’t Enable Scumbags**  
Because you risk becoming one, too.

1. **It’s Your Life. Share it. Celebrate it. Build it. AND HAVE FUN!**  
Enjoy this amazing life we have, and do great things.


***

[![](/images/pragmatic_programmer_book.jpg)](https://www.amazon.com/Pragmatic-Programmer-journey-mastery-Anniversary/dp/0135957052/ref=pd_lpo_14_t_0/146-0897640-2642310?_encoding=UTF8&pd_rd_i=0135957052&pd_rd_r=65420006-fb90-449e-b1f9-cb54a3ee1b00&pd_rd_w=fXjeQ&pd_rd_wg=fZH00&pf_rd_p=7b36d496-f366-4631-94d3-61b87b52511b&pf_rd_r=TCEJ9F1TG2XY34BCR6RM&psc=1&refRID=TCEJ9F1TG2XY34BCR6RM)
...
to discover the raw material behind my content. Current I have over 250 raw 
